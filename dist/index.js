...
const medicao4 = criarMedicao(4, sensorMotorA, 55, new Date());
const medicao5 = criarMedicao(5, sensorMotorA, 105, new Date());
...
const medicoes = [];
medicoes.push(medicao1);
medicoes.push(medicao2);
medicoes.push(medicao3);
medicoes.push(medicao4);
medicoes.push(medicao5);
export {};
